...
public protocol DayStringCodable {
    static func decode(using decoder: Decoder, formatter: DateFormatter) throws -> Self
    func encode(using encoder: Encoder, formatter: DateFormatter) throws
}

extension Day: DayStringCodable {

    public static func decode(using decoder: Decoder, formatter: DateFormatter) throws -> Day {
    ...
    public func encode(using encoder: Encoder, formatter: DateFormatter) throws {
...
@OptionalDayCodable(argumentName: "formatter", argumentType: DateFormatter.self)
extension Day?: DayStringCodable {}
