...
public protocol ISO8601Codable {
    static func decode(from decoder: Decoder, formatter: ISO8601DateFormatter) throws -> Self
    func encode(into encoder: Encoder, formatter: ISO8601DateFormatter, writeNulls: Bool) throws
}

extension Day: ISO8601Codable {

    public static func decode(from decoder: Decoder, formatter: ISO8601DateFormatter) throws -> Day {
    ...
    public func encode(into encoder: Encoder, formatter: ISO8601DateFormatter, writeNulls _: Bool) throws {
...
extension Day?: ISO8601Codable {
    ...
    public func encode(into encoder: Encoder, formatter: ISO8601DateFormatter, writeNulls: Bool) throws {
        if let self {
